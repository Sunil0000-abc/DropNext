...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen bg-linear-to-br from-orange-50 via-white to-orange-50">
      <header className="bg-white/80 backdrop-blur-sm border-b border-gray-200 sticky top-0">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <Image
              src={"/dropnext_logo_12.png"}
              width={900}
              height={400}
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <h2 className="text-2xl sm:text-4xl font-bold text-gray-900 mb-4 tracking-tight md:text:2xl">
            Never Miss a Price Drop
          </h2>
          <p className="text-[13px] text-gray-600 mb-12 max-w-2xl mx-auto">
      ...
      {user && products.length > 0 && (
        <section className="max-w-7xl mx-auto px-4 pb-20">
          ...
          <div className="grid gap-6 md:grid-cols-3 sm:grid-cols-2 items-start">
